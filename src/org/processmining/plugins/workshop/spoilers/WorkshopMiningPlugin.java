 ...
 * 
 */
@Plugin(name = "Mine a Workshop Model", 
		returnLabels = { "Workshop Model" }, 
...
public class WorkshopMiningPlugin {
	...
	@PluginVariant(variantLabel = "Mine a Workshop Model, default", 
	 ...
	 *         parameter values.
	 */
	@UITopiaVariant(affiliation = "UQAC", author = "Method 2", email = "h.m.w.verbeek@tue.nl")
	 ...
	 */
	@UITopiaVariant(affiliation = "UQAC", author = "Method 3", email = "h.m.w.verbeek@tue.nl")
