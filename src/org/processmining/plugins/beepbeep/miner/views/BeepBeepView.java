...
public class BeepBeepView extends JPanel
{
	...
	public BeepBeepView(String tabName, String urlString, String title)
	{
		...
		this.tabbedPane = new IconVerticalTabbedPane(new Color(230, 230, 230, 210),
	 ...
	 */
	protected JRadioButton createRadioButton(final JPanel component, final ButtonGroup buttonGroup,
			final String label, final boolean leftAdjust)
	{
	 ...
	 * @return
	 */
	protected JLabel createLabel(final JPanel component, final String string, Dimension dim,
			boolean leftAdjust, String alignment)
	{
	...
	protected JTextPane createTxtPane(final JPanel component, final String string, Dimension dim,
			boolean leftAdjust, boolean title, float alignment)
	{
