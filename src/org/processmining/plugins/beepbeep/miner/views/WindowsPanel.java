...
import org.processmining.plugins.beepbeep.miner.ReferenceTrend.DataMiningPattern;
...
public class WindowsPanel extends BeepBeepView
{
	...
	{
		super("Windows", "/org/processmining/plugins/beepbeep/miner/views/icons/windowsIcon.png",
		...
		JLabel pastWindowLabel = createLabel(pastWindowPanel,
				"Select the past window for the evaluation of the pattern:", new Dimension(340, 40), false,
				"rigth");
		...
		JLabel presentWindowLabel = createLabel(presentWindowPanel,
				"Select the present window for the evaluation of the pattern:", new Dimension(340, 40),
				false, "rigth");
		// presentWindowTxtPane.setBorder(BorderFactory.createLineBorder(Color.BLUE,
		// 2));
