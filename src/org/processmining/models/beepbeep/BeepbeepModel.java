package org.processmining.models.beepbeep;
...
/**
 * The Beepbeep event model. Allows to keep track of direct succession relation with
 * cardinalities.
 * 
 * @author jalvesnicacio
 * 
 */
public class BeepbeepModel implements HTMLToString{
	...
	/**
	 * Creates a Beepbeep model from the given CSV stream.
	 * 
	 * @param input
	 ...
	 * @throws IOException
	 */
	public BeepbeepModel(InputStream input) throws IOException {
	...
	/**
	 * Creates an empty Beepbeep model for the given collection of event
	 * classes.
	 * 
	 * @param eventClasses
	 *            The given collection of event classes.
	 */
	public BeepbeepModel(XEventClasses eventClasses) {
		successionMap = new HashMap<XEventClass, Map<XEventClass,Integer>>();
	...
	/**
	 * Exports a beepbeep model to a given CSV file.
	 * 
	 * @param file
	 *            The given CSV file.
	 * @throws IOException
	...
	/**
	 * Creates an HTML formatted string from the BeepBeep model. Used for the
	 * basic visualization of the Beepbeep model.
	 * 
